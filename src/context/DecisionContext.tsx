...
const DECISION_STRATEGIES: DecisionStrategy[] = [
  {
    ...
    label: 'Souběh dvou rezervací na stejný zdroj',
    ...
    variants: [
      {
        ...
        action: 'Systém zamkne slot atomicky. Pozdější požadavek odmítnut.',
        impact: 'Jeden uživatel nedostane slot',
        risk: 'nízké',
        recommended: true,
      },
    ],
  },
  {
    ...
    sla_minutes: 60,
    fallback: 'Automatický přechod do no_show, zdroj uvolněn',
    guarding_invariant: null,
    escalation_level: 'L2_manual',
    variants: [
      {
        id: 'kcs02-v1',
        label: 'Upozornit uživatele',
        action: 'Kontaktovat uživatele, zjistit důvod nepřítomnosti',
        impact: 'Zdroj zůstane blokovaný do vyřešení',
        risk: 'nízké',
        recommended: true,
      },
      {
        id: 'kcs02-v2',
        label: 'Evidovat no-show',
        action: 'Označit jako no-show, uvolnit zdroj okamžitě',
        impact: 'Zdroj uvolněn, uživatel upozorněn zpětně',
        risk: 'střední',
        recommended: false,
      },
    ],
  },
  {
    ...
    resolution_type: 'manual_escalation',
    sla_minutes: 30,
    fallback: 'Neoprávněný musí uvolnit zdroj',
    guarding_invariant: null,
    escalation_level: 'L2_manual',
    variants: [
      {
        ...
        action: 'Neoprávněný uživatel musí zdroj uvolnit okamžitě',
        impact: 'Rezervant získá zdroj, neoprávněný přesunut',
        risk: 'nízké',
        recommended: true,
      },
      {
        id: 'kcs03-v2',
        label: 'Domluvit sdílení',
        action: 'Pokud je to možné, domluvit sdílení zdroje',
        impact: 'Oba uživatelé spokojeni, ale omezení',
        risk: 'střední',
        recommended: false,
      },
    ],
  },
  {
    ...
    resolution_type: 'manual_escalation',
    sla_minutes: 120,
    fallback: 'Starší rezervace vyhrává',
    guarding_invariant: null,
    escalation_level: 'L2_manual',
    variants: [
      {
        ...
        action: 'Správce posoudí naléhavost a přidělí zdroj',
        impact: 'Jeden uživatel musí hledat alternativu',
        risk: 'střední',
        recommended: true,
      },
      {
        ...
        action: 'Přednost má dříve vytvořená rezervace',
        impact: 'Transparentní pravidlo, ale možná neoptimální',
        risk: 'nízké',
        recommended: false,
      },
      {
        id: 'kcs04-v3',
        label: 'Alternativní zdroj',
        action: 'Nabídnout oběma alternativní zdroj nebo čas',
        impact: 'Oba spokojeni, ale vyžaduje dostupnost alternativy',
        risk: 'nízké',
        recommended: false,
      },
    ],
