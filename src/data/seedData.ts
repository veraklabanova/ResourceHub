...
export const conflicts: Conflict[] = [
  { id: 'c1', rezervace_id: 'res1', typ: 'no_show', popis: 'Uživatel se nedostavil na rezervovanou zasedačku, ostatní čekali.', řešení: 'Uvolnit zdroj — rezervace převedena do stavu no_show.', stav: 'vyřešený', vytvořeno: '2026-01-05T12:00', eskalace: 'L2', rozhodl: 'Filip Němec', zdůvodnění: 'Uživatel nekomunikoval, zdroj blokován zbytečně.', rozhodnuto: '2026-01-05T12:45' },
  { id: 'c2', rezervace_id: 'res9', typ: 'no_show', popis: 'Zasedačka blokována celé dopoledne, nikdo nepřišel.', řešení: 'Kontaktovat uživatele — omluva přijata, příště upozornění.', stav: 'vyřešený', vytvořeno: '2026-02-02T13:00', eskalace: 'L2', rozhodl: 'Markéta Benešová', zdůvodnění: 'Uživatel zapomněl zrušit, první incident.', rozhodnuto: '2026-02-02T13:30' },
  { id: 'c3', rezervace_id: 'res14', typ: 'neoprávněné_užití', popis: 'Vůz používán osobou bez platné rezervace.', řešení: 'Okamžité uvolnění — uživateli odebrán přístup na 2 týdny.', stav: 'vyřešený', vytvořeno: '2026-02-10T19:00', eskalace: 'L2', rozhodl: 'Filip Němec', zdůvodnění: 'Opakované porušení pravidel, nutná sankce.', rozhodnuto: '2026-02-10T19:20' },
  { id: 'c4', rezervace_id: 'res19', typ: 'neoprávněné_užití', popis: 'Vůz vrácen pozdě, překryv s další rezervací.', řešení: 'Dohoda o sdílení — obě strany souhlasily s posunem.', stav: 'vyřešený', vytvořeno: '2026-03-04T15:00', eskalace: 'L2', rozhodl: 'Markéta Benešová', zdůvodnění: 'Obě strany ochotné ke kompromisu, jednorázová situace.', rozhodnuto: '2026-03-04T15:25' },
  // Aktivní konflikty čekající na rozhodnutí (transient state)
  { id: 'c5', rezervace_id: 'res29', typ: 'dvojitá_rezervace', popis: 'Systémem prošly dvě souběžné rezervace na zasedačku A (res29 a res33). Obě strany trvají na svém termínu.', řešení: '', stav: 'čeká_na_řešení', vytvořeno: '2026-04-13T09:30', eskalace: 'L2', sla_deadline: new Date(Date.now() + 90 * 60 * 1000).toISOString() },
  { id: 'c6', rezervace_id: 'res31', typ: 'no_show', popis: 'Kamera Sony A7III měla být vrácena v 10:00, ale uživatel nekomunikuje. Další uživatel čeká.', řešení: '', stav: 'čeká_na_řešení', vytvořeno: '2026-04-13T10:15', eskalace: 'L2', sla_deadline: new Date(Date.now() + 40 * 60 * 1000).toISOString() },
]
